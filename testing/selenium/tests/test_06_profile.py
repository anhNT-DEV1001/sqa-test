...
class TestProfile:
    ...
    def test_change_password_success(self, driver, db):
        ...
        try:
            ...
            # EMERGENCY ROLLBACK (Đảm bảo DB không bị kẹt nếu bước 3/4 lỗi)
            ...
            if STUDENT_PASSWORD != "@Tuananh10012004" or "/dashboard" not in driver.current_url:
                print(" Kích hoạt Emergency Rollback...")
    ...
    # --- TC_SEL_PROFILE_04: Đổi password sai mật khẩu hiện tại ---
    def test_change_password_wrong_current(self, driver):
        """
        Mục đích: Kiểm tra báo lỗi khi nhập sai mật khẩu hiện tại
        Test Case ID: TC_SEL_PROFILE_04
        """
        self._login_to_profile(driver, STUDENT_USERNAME, STUDENT_PASSWORD)
        profile_page = ProfilePage(driver)
